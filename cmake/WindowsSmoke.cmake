...
file(APPEND "${_asm_file}" "extern GetStdHandle\n")
file(APPEND "${_asm_file}" "extern ReadFile\n")
file(APPEND "${_asm_file}" "extern WriteFile\n")
file(APPEND "${_asm_file}" "extern CreateFileA\n")
file(APPEND "${_asm_file}" "extern CloseHandle\n")
file(APPEND "${_asm_file}" "extern GetFileSizeEx\n")
file(APPEND "${_asm_file}" "extern VirtualAlloc\n")
file(APPEND "${_asm_file}" "extern VirtualFree\n")
file(APPEND "${_asm_file}" "extern CreateProcessA\n")
file(APPEND "${_asm_file}" "extern WaitForSingleObject\n")
file(APPEND "${_asm_file}" "extern GetExitCodeProcess\n")
file(APPEND "${_asm_file}" "extern ExitProcess\n")
file(APPEND "${_asm_file}" "extern GetCommandLineA\n")
file(APPEND "${_asm_file}" "global mainCRTStartup\n")
file(APPEND "${_asm_file}" "section .rdata\n")
file(APPEND "${_asm_file}" "runtime_imports:\n")
file(APPEND "${_asm_file}" "    dq GetStdHandle, ReadFile, WriteFile, CreateFileA\n")
file(APPEND "${_asm_file}" "    dq CloseHandle, GetFileSizeEx, VirtualAlloc, VirtualFree\n")
file(APPEND "${_asm_file}" "    dq CreateProcessA, WaitForSingleObject, GetExitCodeProcess\n")
file(APPEND "${_asm_file}" "    dq ExitProcess, GetCommandLineA\n")
