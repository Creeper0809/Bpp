...
.L284:
    mov rax, 10
    push rax
    lea rax, [rel _gvar__26_global_state_init_suite__g_arr]
    push rax
    mov rax, 0
    imul rax, 2
    pop rbx
    ...
    add rax, rbx
    push rax
    lea rax, [rel _gvar__26_global_state_init_suite__g_ptr]
    pop rbx
    mov [rax], rbx
    mov rax, 42
    push rax
    mov rax, [rel _gvar__26_global_state_init_suite__g_ptr]
    pop rbx
    mov [rax], bl
    lea rax, [rbp-8]
    push rax
    ...
    mov rbx, [rax]
    mov rcx, [rax+8]
    lea rax, [rel _gvar__26_global_state_init_suite__g_slice]
    mov [rax], rbx
    mov [rax+8], rcx
    mov rax, 0
    mov [rbp-40], rax
    mov rax, [rbp-40]
    push rax
    movzx rax, byte [rel _gvar__26_global_state_init_suite__g_u8]
    mov rbx, rax
    pop rax
    add rax, rbx
    push rax
    ...
    mov rax, [rbp-40]
    push rax
    movzx rax, word [rel _gvar__26_global_state_init_suite__g_u16]
    mov rbx, rax
    pop rax
    add rax, rbx
    push rax
    ...
    mov rax, [rbp-40]
    push rax
    mov eax, [rel _gvar__26_global_state_init_suite__g_u32]
    mov rbx, rax
    pop rax
    add rax, rbx
    push rax
    ...
    mov rax, [rbp-40]
    push rax
    mov rax, [rel _gvar__26_global_state_init_suite__g_u64]
    mov rbx, rax
    pop rax
    add rax, rbx
    push rax
    ...
    mov rax, [rbp-40]
    push rax
    mov rax, [rel _gvar__26_global_state_init_suite__g_i64]
    mov rbx, rax
    pop rax
    add rax, rbx
    push rax
    ...
    mov rax, [rbp-40]
    push rax
    lea rax, [rel _gvar__26_global_state_init_suite__g_pair_a]
    mov eax, [rax]
    mov rbx, rax
    pop rax
    add rax, rbx
...
.L285:
    ...
    mov rax, [rbp-48]
    push rax
    lea rax, [rel _gvar__26_global_state_init_suite__g_pair_b1]
    mov rax, [rax]
    mov rbx, rax
    pop rax
    add rax, rbx
    ...
    mov rax, [rbp-48]
    push rax
    lea rax, [rel _gvar__26_global_state_init_suite__g_pair_b2]
    mov rax, [rax]
    mov rbx, rax
    pop rax
    add rax, rbx
    ...
    mov rax, [rbp-48]
    push rax
    lea rax, [rel _gvar__26_global_state_init_suite__g_box]
    mov rax, [rax]
    mov rbx, rax
    pop rax
    add rax, rbx
...
section .data
_gvar__26_global_state_init_suite__g_u8:
    db 1
_gvar__26_global_state_init_suite__g_u16:
    dw 2
_gvar__26_global_state_init_suite__g_u32:
    dd 3
_gvar__26_global_state_init_suite__g_u64:
    dq 4
_gvar__26_global_state_init_suite__g_i64:
    dq 5
_gvar__26_global_state_init_suite__g_pair_a:
    dd 7
    dq 1000
_gvar__26_global_state_init_suite__g_pair_b1:
    dq 40
    dw 2
    db 3
_gvar__26_global_state_init_suite__g_pair_b2:
    dq 9
    dw 1
    db 1
_gvar__26_global_state_init_suite__g_box:
    dq 7
    dq 100
...
_gvar__26_global_state_init_suite__g_ptr: resb 8
_gvar__26_global_state_init_suite__g_arr: resb 8
_gvar__26_global_state_init_suite__g_slice: resb 16
